...
public class DemoGameManager : MonoBehaviour
{
    ...
    void Start()
  {
      ...
      mainGame.mainDeck.AddCard(new DemoSlash(), "Attack");
      mainGame.mainDeck.AddCard(new DemoSlash(), "Attack");
      mainGame.mainDeck.AddCard(new DemoSlash(), "Attack");
      mainGame.mainDeck.AddCard(new DemoSlash(), "Attack");
      mainGame.mainDeck.AddCard(new DemoSlash(), "Attack");
      mainGame.mainDeck.AddCard(new DemoShipRepair(), "Repair");
      mainGame.mainDeck.AddCard(new DemoShipRepair(), "Repair");
      mainGame.mainDeck.AddCard(new DemoShipRepair(), "Repair");
      mainGame.mainDeck.AddCard(new DemoShipRepair(), "Repair");
      mainGame.mainDeck.AddCard(new DemoShipRepair(), "Repair");
      ...
      for(int i = 0; i < 5; i++)
      {
        ...
        DemoCardObject cardObject = newCard.GetComponent<DemoCardObject>();
